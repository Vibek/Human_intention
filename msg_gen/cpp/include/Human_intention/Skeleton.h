/* Auto-generated by genmsg_cpp for file /home/vibek/Human_intention/msg/Skeleton.msg */
#ifndef HUMAN_INTENTION_MESSAGE_SKELETON_H
#define HUMAN_INTENTION_MESSAGE_SKELETON_H
#include <string>
#include <vector>
#include <map>
#include <ostream>
...
struct Skeleton_ {
  ...
  typedef boost::shared_ptr< ::Human_intention::Skeleton_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::Human_intention::Skeleton_<ContainerAllocator>  const> ConstPtr;
  boost::shared_ptr<std::map<std::string, std::string> > __connection_header;
}; // struct Skeleton
typedef  ::Human_intention::Skeleton_<std::allocator<void> > Skeleton;

typedef boost::shared_ptr< ::Human_intention::Skeleton> SkeletonPtr;
typedef boost::shared_ptr< ::Human_intention::Skeleton const> SkeletonConstPtr;


template<typename ContainerAllocator>
std::ostream& operator<<(std::ostream& s, const  ::Human_intention::Skeleton_<ContainerAllocator> & v)
{
  ros::message_operations::Printer< ::Human_intention::Skeleton_<ContainerAllocator> >::stream(s, "", v);
  return s;}
...
{
template<class ContainerAllocator> struct IsMessage< ::Human_intention::Skeleton_<ContainerAllocator> > : public TrueType {};
template<class ContainerAllocator> struct IsMessage< ::Human_intention::Skeleton_<ContainerAllocator>  const> : public TrueType {};
template<class ContainerAllocator>
struct MD5Sum< ::Human_intention::Skeleton_<ContainerAllocator> > {
  static const char* value() 
  {
    return "34722af981b6a61700ff31df5a97c2e0";
  }

  static const char* value(const  ::Human_intention::Skeleton_<ContainerAllocator> &) { return value(); } 
  static const uint64_t static_value1 = 0x34722af981b6a617ULL;
  static const uint64_t static_value2 = 0x00ff31df5a97c2e0ULL;
};

template<class ContainerAllocator>
struct DataType< ::Human_intention::Skeleton_<ContainerAllocator> > {
  static const char* value() 
  {
    return "Human_intention/Skeleton";
  }
...
template<class ContainerAllocator>
struct Definition< ::Human_intention::Skeleton_<ContainerAllocator> > {
  static const char* value() 
  {
...
template<class ContainerAllocator> struct HasHeader< ::Human_intention::Skeleton_<ContainerAllocator> > : public TrueType {};
template<class ContainerAllocator> struct HasHeader< const ::Human_intention::Skeleton_<ContainerAllocator> > : public TrueType {};
} // namespace message_traits
} // namespace ros
...
template<class ContainerAllocator> struct Serializer< ::Human_intention::Skeleton_<ContainerAllocator> >
{
...
template<class ContainerAllocator>
struct Printer< ::Human_intention::Skeleton_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const  ::Human_intention::Skeleton_<ContainerAllocator> & v) 
  {
    s << indent << "header: ";
s << std::endl;
...
#endif // HUMAN_INTENTION_MESSAGE_SKELETON_H
