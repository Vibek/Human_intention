"""autogenerated by genpy from skeleton_markers/Poses.msg. Do not edit."""
import sys
...
"""
  ...
  _slot_types = ['std_msgs/Header','sensor_msgs/CameraInfo','float64','float64','float64','float64','float64','float64','float64[2]','skeleton_markers/PerceptInfo']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.info is None:
        self.info = skeleton_markers.msg.PerceptInfo()
    else:
      self.header = std_msgs.msg.Header()
      self.camera_info = sensor_msgs.msg.CameraInfo()
      self.x = 0.
