"""autogenerated by genpy from skeleton_markers/imagePosition.msg. Do not edit."""
import sys
...
class imagePosition(genpy.Message):
  _md5sum = "61094775b5cd160d76d2c8d9651795b6"
  _type = "skeleton_markers/imagePosition"
...
#### Point in Space of the Image #### 
geometry_msgs/Point point

#### Color of the detected Object ####
string color
...
"""
  __slots__ = ['header','image','point','color']
  _slot_types = ['std_msgs/Header','sensor_msgs/Image','geometry_msgs/Point','string']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(imagePosition, self).__init__(*args, **kwds)
