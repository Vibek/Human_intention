"""autogenerated by genpy from Human_intention/Pose.msg. Do not edit."""
import sys
...
"""
  ...
  _slot_types = ['std_msgs/Header','sensor_msgs/CameraInfo','float64','float64','float64','float64','float64','float64','float64[2]','Human_intention/PerceptInfo']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.info is None:
        self.info = Human_intention.msg.PerceptInfo()
    else:
      self.header = std_msgs.msg.Header()
      self.camera_info = sensor_msgs.msg.CameraInfo()
      self.x = 0.
