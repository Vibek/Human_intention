...
(cl:defmethod cl:initialize-instance :after ((m <Goal>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Goal)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name Human_intention-msg:<Goal> is deprecated: use Human_intention-msg:Goal instead.")))
