...
//--------------------- 1. Set up test data from CSV file ----------------------------------
   ...
   // / string test_filename = "/home/vibek/Human_intention/SVM_training_and_testing_package/trainingTestingData/3Joints_Track/testData_June17.csv";
      
    CvMLData test_data;
	
	test_data.read_csv("/home/vibek/Human_intention/drink_June16.csv");	// read the csv file 
	test_data.set_response_idx(1);
